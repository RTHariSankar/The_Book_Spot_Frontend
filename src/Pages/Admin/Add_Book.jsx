...
import AddBook from "../../Fuctions/Admin/AddBook";

const Add_Book = () => {
  const { bookRegister, bookHandleSubmit, bookWatch, bookErrors, bookHandler } =
    AddBook();
  ...
  return (
    <div>
      ...
      <div className="container mt-5 pt-5 py-4">
        <h1 className="text-center mb-5">Add Books</h1>
        <form onSubmit={bookHandleSubmit(bookHandler)}>
